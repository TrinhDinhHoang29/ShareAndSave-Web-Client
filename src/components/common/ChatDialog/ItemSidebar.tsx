...
interface Props {
	...
	setSelectedItems: React.Dispatch<React.SetStateAction<RequestItem[]>>
}
...
export const ItemSidebar = ({
	...
	if (isAuthor || isAllConfirmed || items.length === 0) return null
							...
							{selectedItems.map(item => (
								...
								>
									...
									<div className='flex items-center gap-1'>
										<button
											onClick={() => handleQuantityChange(item.itemID || 0, -1)}
				...
				{items.map(item => {
					...
					return (
						<motion.div
							...
							onClick={() => availableQuantity > 0 && handleItemSelect(item)}
						>
